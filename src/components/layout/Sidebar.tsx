    ...
    <aside className="hidden lg:block fixed left-0 top-0 w-[280px] h-screen border-r border-[#ffb000] bg-[#0a0a0a] font-mono z-50">
      <div className="p-6 h-full overflow-auto flex flex-col">
        ...
        <div className="mb-8">
          ...
          <div className="text-xs text-[#CC8800] mt-1">$ /bin/sh</div>
        </div>
        ...
        <nav className="mt-auto">
          <div className="text-[#CC8800] text-sm mb-2">$ cat sysinfo</div>
          <div className="pl-2 space-y-1 border-l border-[#CC8800]/30 text-sm">
            <Link
              href="/colophon/"
        ...
        {/* Footer Info */}
        <div className="mt-6 pt-4 border-t border-[#CC8800]/30 text-xs text-[#CC8800]">
